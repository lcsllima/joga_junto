...
api_key = "RGAPI-7b135921-63b3-4ba7-aae8-c61a2d529c64"

def pesquisar_nick(nick, api_key):
    ...
    if not validation:
        ...
        jarvis.execute('''INSERT INTO DadoPesquisa VALUES (?, ?)''', (id, nome))
        conn.commit()
...
pesquisar_nick(sys.argv[1], api_key)
